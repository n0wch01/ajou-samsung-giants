...
<p align="center">
  <img src="security-viz/public/photo/chitoclaw1.png" alt="치토와 치토클로 — 야구장 액션 비주얼" width="49%" />
  <img src="security-viz/public/photo/chitoclaw2.png" alt="치토와 치토클로 — 키 프레젠트 비주얼" width="49%" />
</p>
...
시나리오 본문·절차의 SSOT는 각각 `scenarios/s1-plugin-supply-chain.md`, `s2-data-leakage.md`, `s3-api-abuse.md`이며, 인덱스는 [scenarios/catalog.yaml](scenarios/catalog.yaml)입니다.
